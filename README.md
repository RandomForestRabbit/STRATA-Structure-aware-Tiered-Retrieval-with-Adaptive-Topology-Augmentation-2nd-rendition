...
```
PDF → Typed Segment Extraction (text / table / image caption / heading)   [Phase 1]
...
python run_pipeline.py run --pdf path/to/document.pdf --query "Your question here"

# Run evaluation
python run_eval.py --pdf_dir path/to/pdfs
```
